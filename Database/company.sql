...
# Selecting certain info from table
SELECT *
FROM student
ORDER BY name
LIMIT 2;
...
SELECT * 
FROM student
WHERE name IN ('Claire', 'Kate') AND student_id <3;
# END OF STUDENT TABLE
SELECT * FROM employee;
# BEGINNING OF COMPANY DATABASE
#CREATING TABLES
...
-- Find first 5 employess in table
SELECT * 
FROM employee
LIMIT 5;
...
-- Find out all the differnet genders
SELECT DISTINCT sex
From employee;

-- Find out all the differnet Branch ids
...
SELECT COUNT(emp_id)
FROM employee
WHERE sex = "F" AND birthday_day > '1971-01-01';
...
-- Find the total sales of the salesman
...
-- that Michael Scott manages. Assume you kow Michael's ID
...
ALTER TABLE employee RENAME COLUMN birthday_day TO birth_date;